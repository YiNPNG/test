...
package com.example.dell.mytextapplication.flip;

import com.example.dell.mytextapplication.fliputils.AphidLog;
...
import static com.example.dell.mytextapplication.flip.FlipRenderer.checkError;
import static com.example.dell.mytextapplication.fliputils.TextureUtils.d2r;
import static com.example.dell.mytextapplication.fliputils.TextureUtils.isValidTexture;
import static com.example.dell.mytextapplication.fliputils.TextureUtils.toFloatBuffer;
import static com.example.dell.mytextapplication.fliputils.TextureUtils.toShortBuffer;
...
public class Card {
  ...
  public void draw(GL10 gl) {
    ...
    if (angle > 0) {
      ...
      if (axis == AXIS_TOP) {
        if (orientationVertical) {
          a = (cardVertices[Y_00] - cardVertices[Y_01]) * (1.0f - cos(d2r(angle)));
          h = (float) a;
          b = (cardVertices[Y_00] - cardVertices[Y_01]) * sin(d2r(angle));
          z = (float) b;
          a = 0.0;
          b = 0.0;
          ...
          a = (cardVertices[X_10] - cardVertices[X_00]) * (1.0f - cos(d2r(angle)));
          w = (float) a;
          b = (cardVertices[X_10] - cardVertices[X_00]) * sin(d2r(angle));
          z = (float) b;
          a = 0.0;
          b = 0.0;
          shadowVertices = new float[]{
        ...
        if (orientationVertical) {
          a = (cardVertices[Y_00] - cardVertices[Y_01]) * (1f - cos(d2r(angle)));
          h = (float) a;
          b = (cardVertices[Y_00] - cardVertices[Y_01]) * sin(d2r(angle));
          z = (float) b;
          a = 0.0;
          ...
          a = (cardVertices[X_10] - cardVertices[X_00]) * (1f - cos(d2r(angle)));
          w = (float) a;
          b = (cardVertices[X_10] - cardVertices[X_00]) * sin(d2r(angle));
          z = (float) b;
          a = 0.0;
