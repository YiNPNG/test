...
public class FlipViewController extends AdapterView<Adapter> {
  ...
  private final LinkedList<View> releasedViews = new LinkedList<View>(); //use a SparseArray to keep the related view indices?
  ...
  private void setupSurfaceView(Context context) {
    ...
    addViewInLayout(surfaceView, -1, new AbsListView.LayoutParams(LayoutParams.MATCH_PARENT,
