package com.example.dell.texttwo.po;
...
public final class PFile {
	...
	public Bitmap getThumb(Context ctx) {
		/*return null;*/
		return MediaStore.Video.Thumbnails.getThumbnail(ctx.getApplicationContext(), ctx.getContentResolver(), _id, MediaStore.Video.Thumbnails.MICRO_KIND, null);
	}
